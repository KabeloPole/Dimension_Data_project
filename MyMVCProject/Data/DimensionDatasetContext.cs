...
{
    public partial class DimensionDatasetContext : DbContext
    {
        public DimensionDatasetContext()
        {
        }

        public DimensionDatasetContext(DbContextOptions<DimensionDatasetContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Initial Catalog=DimensionDataset;Data Source=KABELO-POLE;Trusted_Connection=true");
            }
        }
